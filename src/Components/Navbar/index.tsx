            ...
            <div className="relative flex items-center justify-between h-16">
              <div className="absolute inset-y-0 left-0 flex items-center md:hidden">
                ...
                <Popover>
                  ...
                  >
                    <Popover.Panel
                      focus
                      className="absolute z-10 top-0 mr-3 p-2 transition transform origin-top-right md:hidden"
                    >
                          ...
                          {navigation.map((item) => (
                            <a
                              ...
                              className={classNames(
                                item.current
                                  ? "bg-gray-900 text-white flex gap-1.5 items-center justify-center text-lg"
                                  : "text-gray-300 hover:bg-gray-700 hover:text-white flex gap-1.5 items-center justify-center  text-lg",
              ...
              <div className="flex-1 flex items-center justify-center md:items-stretch md:justify-start">
                <div className="flex-shrink-0 flex items-center">
                  ...
                  <a
                    href="/"
                    className=" mt-auto hidden md:block h-8 w-auto text-white font-bold underline underline-offset-2 ml-1 "
                  >
                    DANKTT
                  </a>
                  <span className=" mx-auto  block md:hidden md:self-center  h-8 w-auto text-white font-bold underline underline-offset-2 ml-1 ">
                    DANKTT
                  </span>
                </div>
                  ...
                  <div className="flex space-x-4">
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current
                            ? "bg-gray-900 text-white flex gap-1.5 items-center"
                            : "text-gray-300 hover:bg-gray-700 hover:text-white flex gap-1.5 items-center",
